...
console.log('1:', copy(originalFlavors));
...
console.log('2:', is31Flavors(originalFlavors));
...
console.log('3:', addFlavor(originalFlavors, 'Rainbow Sherbert'));
...
console.log('4:', removeLastFlavor(originalFlavors));
...
console.log('5:', getFlavorByIndex(originalFlavors, 2));
...
console.log('6:', removeFlavorByName(originalFlavors, 'Rocky Road'));
...
console.log('7:', filterByWord(originalFlavors, 'Chocolate'));
